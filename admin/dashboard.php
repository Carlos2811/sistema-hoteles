...
<?php
$result ="SELECT count(*) FROM hoteles ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Hoteles</div>
												</div>
											</div>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center">
<?php
$result1 ="SELECT count(*) FROM habitaciones ";
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light">
												<div class="stat-panel text-center">
<?php
$result2 ="SELECT count(*) FROM admin ";
...
?>
													...
													<div class="stat-panel-title text-uppercase">Total de Usuarios</div>
												</div>
											</div>
