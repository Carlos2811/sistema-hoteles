...
$roomno=$_POST['rmno'];
$fees=$_POST['fee'];
$sql="SELECT habitacion FROM habitaciones where cantidad=?";
...
<?php } ?>
										<form method="post" class="form-horizontal">
											...
											<div class="form-group">
												<label class="col-sm-2 control-label">Seleccionar acomodacion  </label>
												<div class="col-sm-8">
												<Select name="seater" class="form-control" required>
<option value="">Seleccionar Acomodacion</option>
...
<div class="form-group">
<label class="col-sm-2 control-label">Tipo de Habitacion</label>
<div class="col-sm-8">
