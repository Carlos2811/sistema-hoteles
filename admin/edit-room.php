...
$fees=$_POST['fees'];
$id=$_GET['id'];
$query="update habitaciones set seater=?,fees=? where id=?";
...
<body>
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						</br></br><h2 class="page-title">Editar Detalles de Cuarto </h2>
								...
								<div class="panel panel-default">
									...
									<div class="panel-body">
										<form method="post" class="form-horizontal">
												<?php	
												$id=$_GET['id'];
	$ret="select * from habitaciones where id=?";
	...
	<span class="help-block m-b-none">
													El número del cuarto no puede ser cambiado.</span>
						 </div>
						</div>
<div class="form-group">
